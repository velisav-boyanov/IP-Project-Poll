...
public class JwtAuthenticationController {
    ...
    public ResponseEntity<?> loginAuthenticationToken(@RequestBody JwtRequest authenticationRequest) throws Exception {
    ...
    public ResponseEntity<?> registerAuthenticationToken(@RequestBody JwtRequest authenticationRequest) throws Exception {
        userRepository.save(new DbUserModel(authenticationRequest.getUsername(), authenticationRequest.getPassword()));
